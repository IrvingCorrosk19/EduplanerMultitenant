-- Solo crea las tablas de carnets (sin tocar __EFMigrationsHistory).
-- Para BD local donde no existe la tabla de historial de EF.
-- Uso: psql -h localhost -U postgres -d schoolmanagement -f Scripts/ApplyIdCardTables_LocalOnly.sql
