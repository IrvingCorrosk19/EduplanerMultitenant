        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "institutional_credential_cards_school_id_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "staff_institutional_profiles_school_id_fkey",
                        column: x => x.school_id,
                        principalTable: "schools",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "staff_qr_tokens_school_id_fkey",
                        column: x => x.school_id,
                        principalTable: "schools",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_institutional_credential_cards_school_id",
                table: "institutional_credential_cards",
                column: "school_id");

            migrationBuilder.CreateIndex(
                name: "IX_institutional_credential_cards_school_id_status",
                table: "institutional_credential_cards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_staff_institutional_profiles_school_id",
                table: "staff_institutional_profiles",
                column: "school_id");

            migrationBuilder.CreateIndex(
                name: "IX_staff_qr_tokens_school_id",
