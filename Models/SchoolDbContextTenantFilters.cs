...
public partial class SchoolDbContext
{
    ...
    {
        // When _tenantId is null (superadmin / no HTTP context), filters are bypassed → all records visible.
        // When set, every query automatically scopes to the current school.
